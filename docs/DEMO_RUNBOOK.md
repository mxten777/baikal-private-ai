...
> **버전**: 1.0 (Docker 배포 환경 기준)  
> **작성일**: 2026-04-03  
> **환경**: Windows 11 + Docker Desktop (CPU 모드)  
> **총 소요 시간**: 준비 8분 + 시연 15분
...
**강조 포인트**:
- 관리자/일반사용자 **역할 기반 접근 제어(RBAC)**
- 부서별·직급별 계정 분리 운영 가능
- 계정 비활성화로 즉시 접근 차단

---

### 🎬 Scene 6 — (선택) 폐쇄망 증명 (1분)
